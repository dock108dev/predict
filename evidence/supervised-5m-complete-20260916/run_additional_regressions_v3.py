...
with patch('socket.socket.connect',connect),patch('app.collection.venue_access.load_credentials',side_effect=AssertionError('credentials blocked')):
    names={'d2':['tests.test_continuous'],'d2-stub-corrected':['tests.test_continuous'],'d2-repair':['tests.test_d2_repair'],'d2-repair-stub-corrected':['tests.test_d2_repair'],'retained':['tests.test_supervised.Retained','tests.test_segmented.SavedCalculations']}[mode]
