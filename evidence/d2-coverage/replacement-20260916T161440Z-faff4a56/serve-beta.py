"""Explicit replacement-attempt configuration; unchanged D2 collector, idle startup."""
import sys
...
owner = CoverageOwner(OUTPUT, pilot_output=Path('/Users/michaelfuscoletti/Desktop/prediction-arb/evidence/d2-coverage/replacement-20260916T161440Z-faff4a56'))
