...
```json
{
  ...
  "paths": {
    "/auth/login": {
      "post": {
        "description": "Please access to our website, in Settings/Token to get/create a list of tokens to login with this endpoint",
        "tags": [
          "Auth"
        ],
        ...
        "requestBody": {
          "content": {
            "application/json": {
              "schema": {
                "$ref": "#/components/schemas/market_maker.LoginRequest"
              }
            }
          },
          "description": "body",
        ...
        "responses": {
          "200": {
            ...
            "content": {
              "application/json": {
                "schema": {
                  "$ref": "#/components/schemas/market_maker.SuccessLogin"
                }
              }
            }
          },
