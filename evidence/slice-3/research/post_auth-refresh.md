---
updatedAt: 2026-09-10T16:12:02.000Z
---
...
Please use this endpoint to refresh your "access_token" after login, access_token will expire after 10 minutes and can be refresh using "refresh_token" given by /auth/login endpoint
...
```json
{
  ...
  "paths": {
    "/auth/refresh": {
      "post": {
        "description": "Please use this endpoint to refresh your \"access_token\" after login, access_token will expire after 10 minutes and can be refresh using \"refresh_token\" given by /auth/login endpoint",
        "tags": [
          "Auth"
        ],
        ...
        "requestBody": {
          "content": {
            "application/json": {
              "schema": {
                "$ref": "#/components/schemas/market_maker.RefreshRequest"
              }
            }
          },
          "description": "body",
        ...
        "responses": {
          "200": {
            ...
            "content": {
              "application/json": {
                "schema": {
                  "$ref": "#/components/schemas/market_maker.SuccessRefresh"
                }
              }
            }
          },
