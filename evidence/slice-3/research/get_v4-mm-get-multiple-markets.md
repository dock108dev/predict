...
```json
{
  ...
  "paths": {
    "/v4/mm/get_multiple_markets": {
      "get": {
        ...
        "summary": "List multiple markets v4",
        "parameters": [
          {
            "name": "event_ids",
            "in": "query",
        ...
        "responses": {
          "200": {
            ...
            "content": {
              "application/json": {
                "schema": {
                  "$ref": "#/components/schemas/market_maker.MMListWithMultipleEventResponseV4"
                }
              }
            }
          },
  ...
  "components": {
    ...
    "schemas": {
      "market.MMListWithMultipleEventResponseV4": {
        "type": "object",
        "additionalProperties": {
          "type": "array",
          "items": {
            "$ref": "#/components/schemas/v4.MMMarketV4"
          }
        }
      },
      "market_maker.MMListWithMultipleEventResponseV4": {
        "type": "object",
        "properties": {
          "data": {
            "$ref": "#/components/schemas/market.MMListWithMultipleEventResponseV4"
          }
        }
      },
      "v4.MMMarketV4": {
        ...
        "properties": {
          ...
          "selections": {
            ...
            "items": {
              "type": "array",
              "items": {
                "$ref": "#/components/schemas/v4.Selection"
              }
            }
          },
          "status": {
