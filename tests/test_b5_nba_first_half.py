...
from tests.test_b5_score_lines import fixture as full_fixture
...
class Filters(unittest.TestCase):
    def test_three_families_filter_and_unknown_winner(self):
        from tests.b5_nba_first_half_preview import combined_fixture
...
class StopAPI(shared.ScoreStopAPI):
    def setUp(self):
        from tests import b5_score_lines_preview,b5_nba_first_half_preview
        self.addCleanup(patch.stopall);patch.object(b5_score_lines_preview,'owner',b5_nba_first_half_preview.owner).start()
