...
from tests.test_b5_nba_resolution import fixture,rec
...
if __name__=='__main__':
    import sys
    web.run_app(create_app(owner=owner(Path(sys.argv[1]),sys.argv[2] if len(sys.argv)>2 else 'first_half'),sessions={}),host='127.0.0.1',port=8812,access_log=None)
