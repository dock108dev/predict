...
from tests.test_nba_first_half import fixture as half
from tests.test_score_lines import fixture as full
from tests.test_nba import fixture as winner
...
class Lifecycle(shared.Lifecycle):
    def setUp(self):
        ...
        from tests.nba_resolution_preview import owner
