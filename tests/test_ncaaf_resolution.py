...
from tests import test_nfl_resolution as shared
from tests.test_ncaaf_first_half import fixture as half
from tests.test_ncaaf_lines import fixture as full
from tests.test_ncaaf import fixture as winner
...
class Lifecycle(shared.Lifecycle):
    def setUp(self):
        from tests import nfl_resolution_preview as preview
        from tests.ncaaf_resolution_preview import owner
...
class CollegeSpecific(unittest.TestCase):
    def test_six_school_membership_and_fcs_contract_gaps(self):
        from tests.test_ncaaf import matchup
