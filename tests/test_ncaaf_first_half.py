...
from tests.test_ncaaf_lines import fixture as full_fixture
...
class Filters(unittest.TestCase):
    def test_all_families_periods_and_unsupported_fcs(self):
        from tests.ncaaf_first_half_preview import combined_fixture
...
class StopAPI(shared.ScoreStopAPI):
    def setUp(self):
        from tests import score_lines_preview,ncaaf_first_half_preview
        self.addCleanup(patch.stopall);patch.object(score_lines_preview,'owner',ncaaf_first_half_preview.owner).start()
