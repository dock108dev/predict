...
from tests.test_b5_nfl_lines import fixture,reference


def combined_fixture():
    nba=fixture();college=fixture('NFL','total','44.5')
...
if __name__=='__main__':
    import sys
    web.run_app(create_app(owner=owner(Path(sys.argv[1])),sessions={}),host='127.0.0.1',port=8803,access_log=None)
