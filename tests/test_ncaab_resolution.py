...
from tests.test_ncaab_first_half import fixture as half
from tests.test_score_lines import fixture as shared_full

def full(**kw):return shared_full('NCAAB',**kw)
from tests.test_ncaab import fixture as winner
...
class Lifecycle(shared.Lifecycle):
    def setUp(self):
        ...
        from tests.ncaab_resolution_preview import owner
