...
from tests.test_b5_nba_first_half import fixture,reference
...
def combined_fixture():
    base=None
    for family,line,period in [('moneyline',None,'first_half'),('spread','-3','first_half'),('total','110.5','first_half'),('spread','-3','full_game'),('moneyline',None,'unsupported')]:
...
if __name__=='__main__':
    import sys
    web.run_app(create_app(owner=owner(Path(sys.argv[1])),sessions={}),host='127.0.0.1',port=8809,access_log=None)
