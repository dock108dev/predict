...
from tests.test_nfl_resolution import wrappers,alter
from tests.test_mlb_lines import fixture as baseball
from tests.test_nhl_lines import fixture as hockey
...
class Results(unittest.TestCase):
    ...
    def test_full_game_winner_and_legacy_binding(self):
        from tests.test_mlb import fixture as mlb_winner
        from tests.test_nhl import fixture as nhl_winner
    ...
    def test_shortened_official_winner_does_not_settle_lines(self):
        from tests.test_mlb import fixture as winner
