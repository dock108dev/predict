# B5 MLB full-game run-line/total handoff

**COMPLETE — bounded offline engineering and isolated synthetic acceptance, September 22, 2026.** Actual venue/model qualification and full B4/B5 remain open. **Beta NOT READY FOR SIGNOFF.**
...
- **B3/B5:** actual MLB native run-line/total listings, game discriminators, side/sign/period fields, applicable source contracts (especially total pitcher conditions), fee history/overrides, usable quantities, and exceptional/refund economics. PMUS US-specific rules remain missing; Novig/ProphetX requests pending.
- **B4:** actual exact-line distributions, provenance/independence and compatible MLB Pinnacle inputs. Prior NFL h2h sample is preserved; no additional credit/request.
- **B5:** unsupported pitcher/shortened/refund economics, innings/team totals, portfolios/quarter stakes, series/futures, actual historical qualification and result/settlement linkage remain open.
