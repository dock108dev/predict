...
September 21, 2026. Owner requested GraphQL for now, with NBX if it is not useful. **Useful narrowly: discovery and dated display prices. Not sufficient for venue integration purchase comparisons.** No endpoint query or credential access occurred.
