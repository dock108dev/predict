# B5 shared full-game score lines — bounded engineering handoff

**COMPLETE: NBA and men’s Division I NCAAB integer/half-point full-game spread/total engineering.** Fixture/offline acceptance only. Actual venue/model qualification, full B4/B5 and beta signoff remain open. **Beta NOT READY FOR SIGNOFF.**
...
- **B3:** actual NBA/NCAAB native line listings, scoped review annotations, current source rules, quantities, fee applicability and exceptional/refund economics. Novig/ProphetX requests remain pending; ProphetX selected. No new credits, credentials, messages or collection.
- **B4:** actual explicitly bound cover/total distributions, provenance and independence. KenPom deferred. MoneyPuck dropped; NHL analytics missing/deferred. No acquisition prerequisite for independent engineering.
- **B5:** remaining roster/seasons, NFL/NCAAF point mappings, MLB run-line/pitcher/shortening mappings, NHL puck-line/shootout goal treatment; other periods/futures remain separate.
