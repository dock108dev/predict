...
- Required result matrix separates implemented/offline, historical QA, fresh production and actual ordinary-comparison participation. A missing venue, unresolved overlap or absent updates fails venue integration exit criteria. Do not automatically retry a failed run.
