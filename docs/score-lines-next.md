# Next market support slice — shared full-game spread/total calculations

**Completed bounded proposal:** [implementation and acceptance handoff](score-lines-handoff.md). The original scope below is retained for traceability. [NFL mapping is subsequently complete](nfl-lines-handoff.md); [NCAAF mapping is subsequently complete](ncaaf-lines-handoff.md); next independent work is MLB full-game run-line/total mapping.
